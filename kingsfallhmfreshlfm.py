...
notes_add.send_keys("#lfm Need 3 for HM FRESH RUN. Must have a mic, know all boss mechanics, and be +300 Light. MESSAGE AND FRIEND REQUEST ME ON PSN, I WON'T ANSWER HERE")
